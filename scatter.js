...
d3.chart.scatter = function() {
  ...
  chart.update = update;
  function update() {
    var maxCreated = d3.max(data, function(d) { return Date(d.properties.article_date) });
    var minCreated = d3.min(data, function(d) { return Date(d.properties.article_date) });
    ...
    .transition()
    .attr({
      cx: function(d,i) { return createdScale(d.properties.article_date) },
    ...
    for(var i = 0; i < layout.length; i++) {
      var bin = layout[i];
      g.selectAll("circle")
      .data(bin, function(d) { return d.properties.id })
  ...
  chart.highlight = function(data) {
    ...
    circles.data(data, function(d) { return d.properties.id })
    .style("stroke", "orange")
